# Extend the Streamlit app to include CSV export functionality

final_app_code = {
    "streamlit_rag_spi_pipeline.py": """
...
# Save the final app with CSV export
output_dir = Path("/mnt/data/streamlit_rag_spi_pipeline")
for filename, content in final_app_code.items():
